...
// 1.6 - 04JUL21 - tidied up comments
// 1.5 - 02JUL21 - fixed issue with function keys
// 1.0 to 1.4 - 04MAY21 - initial design
...
// CONSTANTS:
const int row1 = 21;          //keypad matrix row 1
const int row2 = 10;          //keypad matrix row 2
const int row3 = 20;          //keypad matrix row 3
const int row4 = 16;          //keypad matrix row 4
const int row5 = 19;          //keypad matrix row 5
const int row6 = 14;          //keypad matrix row 6
const int row7 = 18;          //keypad matrix row 7
const int row8 = 15;          //keypad matrix row 8

const int col1 = 2;           //keypad matrix col 1
const int col2 = 3;           //keypad matrix col 2
const int col3 = 4;           //keypad matrix col 3
const int col4 = 5;           //keypad matrix col 4
const int col5 = 6;           //keypad matrix col 5
const int col6 = 7;           //keypad matrix col 6
const int col7 = 8;           //keypad matrix col 7
const int col8 = 9;           //keypad matrix col 8
